    ...
    return (
      React.createElement("div", {className: "col-xs-12 col-sm-6 panel"}, 
        ...
        React.createElement(ReactSwipe, {ref: "ReactSwipe"}, 
          ...
          React.createElement("div", null, 
            React.createElement(MovieDay, {name: this.props.name, imagePath: this.props.imagePath, dates: this.props.dates})
          ), 
          React.createElement("div", null, 
            "Trailer"
          )
...
var MovieDay = React.createClass({displayName: "MovieDay",
  drawSchedule: function (canvas, ctx) {
    ...
    this.props.dates.forEach(function (dateString) {
      ...
      ctx.fillText(date.getTime().toString().slice(0,5), 10, height / HOURS + minutes / (HOURS * 60) * (height - height/HOURS));
    });
  },
  componentDidMount: function () {
