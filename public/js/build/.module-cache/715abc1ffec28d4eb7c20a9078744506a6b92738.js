    ...
    return (
      React.createElement("div", {className: "col-xs-12 col-sm-6 panel"}, 
        ...
        React.createElement(ReactSwipe, {ref: "ReactSwipe"}, 
          React.createElement("div", null, 
            React.createElement("a", {href: "#", onClick: this.next}, " bububu "), 
            React.createElement("h4", {className: "olala"}, " ih-ih "), 
            React.createElement("img", {className: "movieImage img-rounded poster", src: this.props.imagePath, alt: this.props.name, width: "100%", style: imgStyle})
          ), 
          movieDays, 
          React.createElement("div", null, 
            "Trailer"
