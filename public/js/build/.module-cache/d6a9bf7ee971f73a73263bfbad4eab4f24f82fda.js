...
var MovieList = React.createClass({displayName: "MovieList",
  render: function() {
    var movieNodes = this.props.data.map(function(movie) {
      ...
      return (
        React.createElement(MovieCard, {id: movie._id, name: movie.name, imagePath: imagePath, dates: movie.dates}
        )
      );
    });
    return (
      ...
      React.createElement("div", {className: "col-xs-12 col-sm-6 panel"}, 
        ...
        React.createElement(ReactSwipe, {ref: "ReactSwipe"}, 
          React.createElement("div", null, 
            ...
            React.createElement("img", {clasName: "movieImage img-rounded", src: this.props.imagePath, alt: this.props.name, width: "100%", style: style})
          ), 
          React.createElement("div", null, 
            React.createElement(MovieTime, {id: this.props.id, name: this.props.name, imagePath: this.props.imagePath, dates: this.props.dates})
          ), 
          React.createElement("div", null, 
            "Trailer"
          )
...
var MovieTime = React.createClass({displayName: "MovieTime",
  ...
  render: function () {
    return (
      React.createElement("canvas", {id: this.props.id, width: "300px", height: "400px"})
    );
  }
});
