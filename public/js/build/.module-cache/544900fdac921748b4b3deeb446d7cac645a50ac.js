...
var MovieCard = React.createClass({displayName: "MovieCard",
  render: function() {
    ...
    return (
      React.createElement("div", {className: "movieCard .col-xs-12 .col-sm-6"}, 
        React.createElement("h4", {className: "movieName"}, 
          this.props.name
        ), 
        React.createElement("img", {clasName: "movieImage", src: this.props.imagePath, alt: this.props.name})
      )
    )
  }
});
