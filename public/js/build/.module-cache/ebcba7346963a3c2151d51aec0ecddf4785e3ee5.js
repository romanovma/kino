    ...
    return (
      React.createElement("div", {className: "movieBox container"}, 
          ...
          React.createElement("div", null, 
            React.createElement(ImageList, {data: this.state.data})
          ), 
          React.createElement("div", null, 
            React.createElement(ScheduleList, {data: this.state.data})
          ), 
          React.createElement("div", null, 
            React.createElement(TrailerList, {data: this.state.data})
          )
