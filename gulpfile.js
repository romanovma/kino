...
gulp.task('build',['cjsx', 'coffee', 'js', 'scss']);

// Start the server in ./build
gulp.task('server', function() {
  if (node) node.kill();
  if(!fs.existsSync(buildDir+'www.js')){
    console.log(buildDir+'www.js not found, retrying...');
  ...
  node = spawn('node', [buildDir+'www.js'], {stdio: 'inherit'});
